...
% Primary: Try local Noto Serif Bengali (bundled in fonts/bangla-font/)
\IfFileExists{./fonts/bangla-font/NotoSerifBengali-Regular.ttf}{
    \newfontfamily\bengalifont{NotoSerifBengali}[
        Path = ./fonts/bangla-font/,
        Extension = .ttf,
        UprightFont = *-Regular,
        BoldFont = *-Bold,
        Script=Bengali,
    ...
    % Fallback: FreeSerif (system default)
...
% Primary: Try local Noto Sans Bengali (bundled in fonts/bangla-font/)
\IfFileExists{./fonts/bangla-font/NotoSansBengali-Regular.ttf}{
    \newfontfamily\bengalisansfont{NotoSansBengali}[
        Path = ./fonts/bangla-font/,
        Extension = .ttf,
        UprightFont = *-Regular,
        BoldFont = *-Bold,
    ...
    % Fallback: FreeSans (system default)
    \newfontfamily\bengalisansfont{FreeSans}[
        Script=Bengali,
        Scale=0.9
    ]
}
